...
const NAV_ITEMS: Record<UserRole, NavItem[]> = {
  ...
  internship_advisor: [
    { 
      ...
      children: [
        ...
        { label: "Academic Oversight", path: "/internship-advisor/oversight", icon: BookMarked },
        { label: "Students", path: "/internship-advisor/students", icon: Users },
        { label: "Logbooks", path: "/internship-advisor/logbooks", icon: BookOpen },
        { label: "Submissions", path: "/internship-advisor/submissions", icon: FileUp },
  ...
  company_supervisor: [
    ...
    { label: "Submissions", path: "/company-supervisor/submissions", icon: FileUp },
